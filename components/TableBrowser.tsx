...
export function TableBrowser() {
  ...
  return (
    <div className="flex h-full">
      {/* Left: table list */}
      <div className="w-44 shrink-0 border-r border-white/5 overflow-y-auto p-2 flex flex-col gap-0.5">
        {tables.map(t => (
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex items-center justify-between px-4 py-2.5 border-b border-white/5 shrink-0">
          <div className="flex items-center gap-2">
            <span className="text-xs font-mono text-violet-300 font-semibold">{selectedTable}</span>
        ...
        {data && data.totalCount > PAGE_SIZE && (
          <div className="flex items-center justify-between px-4 py-2.5 border-t border-white/5 shrink-0">
            <span className="text-xs text-gray-600">Rows {startRow}–{endRow} of {data.totalCount.toLocaleString()}</span>
            <div className="flex items-center gap-1">
              ...
              <span className="text-xs text-gray-500 px-2">Page {tableBrowserPage + 1} / {totalPages}</span>
